...
def upload():
    if request.method == 'POST':
        ...
        if img:
                ...
                msg = "Upload Done ! "
                return redirect(url_for("upload_file_page",msg=msg))
...
def download(id):
    ...
    return render_template("upload_file_page.html", assignment_files=assignment_files, msg_2=msg_2, response=response)
...
def upload_file_page():
    ...
    return render_template("upload_file_page.html", assignment_files=assignment_files)
